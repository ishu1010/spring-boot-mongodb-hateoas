...
public class BookStoreControllerTest {
	...
	public void getBookCatalog_shouldReturnSuccessful() throws Exception {
		when(bookService.getAllResource()).thenReturn(getBookDTOList());
	...
	public void saveBook_shouldReturnSuccessful() throws Exception {
		...
		when(bookService.createResource(Mockito.<BookDTO>any())).thenReturn(bookDTO);
		...
		verify(bookService, times(1)).createResource(Mockito.<BookDTO>any());
	}
